 ...
 */
public class CalculatorFikri extends javax.swing.JFrame { 

    String angka;
    double jumlah, angka1, angka2;
    int pilih;
    public CalculatorFikri() {
        initComponents();
        angka="";
    }
    ...
    private void initComponents() {
        ...
        btnAngka9.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        btnAngka9.setText("9");
...
pilih=4;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculatorFikri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculatorFikri().setVisible(true);
            }
        });
    }
